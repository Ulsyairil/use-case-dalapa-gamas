    ...
    <div class="nk-sidebar-element nk-sidebar-head">
       ...
       <div class="nk-sidebar-brand">
            <a href="{{ url('/') }}" class="logo-link nk-sidebar-logo">
                ...
                <h4 class="logo-light logo-img">{{ config('app.name') }}</h4>

                {{-- Full logo for dark theme --}}
                <h4 class="logo-dark logo-img">{{ config('app.name') }}</h4>

                {{-- Small logo when sidebar is collapsed --}}
                <h4 class="logo-small logo-img logo-img-small">
                    {{ Str::limit(config('app.name'), 2, '') }}
                </h4>
            </a>
        </div>
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-item active">
                        <a href="{{ route('ticket.view') }}" class="nk-menu-link active">
                            <span class="nk-menu-icon"><em class="icon ni ni-ticket-off"></em></span>
                            <span class="nk-menu-text">{{ __('custom.incident_ticket') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                <a href="html/orders-regular.html" class="nk-menu-link"><span class="nk-menu-text">Order
                                        List - Regular</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="html/orders-sales.html" class="nk-menu-link"><span class="nk-menu-text">Order
                                        List - Sales</span></a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item">
                                ...
                                <ul class="nk-menu-sub">
                                    ...
                                    <li class="nk-menu-item"><a href="html/components/forms/wizard/create-project.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Create Project</span></a>
                                    </li>
                                    <li class="nk-menu-item"><a href="html/components/forms/wizard/create-profile.html"
                                            class="nk-menu-link"><span class="nk-menu-text">Create Profile</span></a>
                                    </li>
                                    <li class="nk-menu-item"><a href="html/components/forms/wizard/two-factor-auth.html"
